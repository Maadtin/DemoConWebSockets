...
public class DemoConWebSocketsApp {

    private static final Logger log = LoggerFactory.getLogger(DemoConWebSocketsApp.class);

    private final Environment env;

    public DemoConWebSocketsApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes DemoConWebSockets.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DemoConWebSocketsApp.class);
